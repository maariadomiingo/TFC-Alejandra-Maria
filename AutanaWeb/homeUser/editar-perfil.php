...
<div id="passwordModal" class="fixed inset-0 z-50 hidden bg-black bg-opacity-40 flex items-center justify-center">
  <div class="bg-white rounded-lg p-6 w-full max-w-md shadow-lg relative">
    ...
    <input type="password" id="current_password" class="input mb-4" placeholder="Enter current password">
    <label for="new_password" class="block text-sm font-medium text-gray-700">New Password</label>
    <input type="password" id="new_password" class="input mb-4" placeholder="Enter new password">
    ...
    <div class="flex justify-end space-x-2">
      ...
      <button type="button" onclick="changePassword()" class="bg-black text-white px-4 py-2 rounded hover:bg-gray-800">Save</button>
    </div>
